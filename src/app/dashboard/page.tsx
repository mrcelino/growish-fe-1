  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-3 gap-10">
        <div className="flex flex-col items-center justify-center bg-[#A9DBA4] rounded-2xl p-8 mt-6 min-h-44 shadow-md gap-2">
          <h2 className="text-3xl font-bold">120</h2>
          <h2 className="text-2xl font-semibold">Total Bahan Pangan</h2>
        </div>
        <div className="flex flex-col items-center justify-center bg-[#A9DBA4] rounded-2xl p-4 mt-6 min-h-44 shadow-md gap-2">
          <h2 className="text-3xl font-bold">15</h2>
          <h2 className="text-2xl font-semibold">Bahan Terbaru (7 Hari)</h2>
        </div>
        <div className="flex flex-col items-center justify-center bg-[#A9DBA4] rounded-2xl p-4 mt-6 min-h-44 shadow-md gap-2">
          <h2 className="text-3xl font-bold">5</h2>
          <h2 className="text-2xl font-semibold">Kategori Bahan</h2>
        </div>
      </div>
    </div>
  );
